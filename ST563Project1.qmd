...
logitMod <- glm(bankrupt ~ ., data = data1, family=binomial())
```
This is the same warning I got in my original evaluation of the datasets, "algoritm did not converge".  This may be due to collinearity between the myriad variables.  I will check out the covariance matrix to see if we can identify some variables to remove.
